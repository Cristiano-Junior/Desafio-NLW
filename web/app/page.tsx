  ...
  return <main className="grid grid-cols-2 min-h-screen">
    ...
    <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
      ...
      <div className='space-y-5'> 
        ...
        <a href="" className='inline-block rounded-full bg-green-500 px-5 py-2 font-alt text-sm uppercase leading-none text-black hover:bg-green-700'>CADASTRAR LEMBRANÇA</a>
      </div>

      {/** Copyright */}
      <div className='text-sm leading-relaxed text-gray-200'>
        Feito com 💜 no NLW da <a href="https://www.rocketseat.com.br" rel="noreferrer" target='_blank' className='underline hover:text-gray-100'>Rocketseat</a>
      </div>
    ...
    <div className="flex flex-col p-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
      <div className="flex flex-1 items-center justify-center">
        <p className="text-center leading-relaxed w-[360px]">
          Você ainda não criou nenhuma lembrança, comece a <a className="underline hover:text-gray-50" href="">criar agora!</a>
        </p>
      </div>
    </div>
  </main>
